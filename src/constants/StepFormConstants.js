export const OPEN_MODAL = 'StepFormConstants/OPEN_MODAL';
export const CLOSE_MODAL = 'StepFormConstants/CLOSE_MODAL';

export const SET_STEP = 'StepFormConstants/SET_STEP';
